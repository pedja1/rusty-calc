...
use slint_generated::{Globals, LauncherWindow, MainWindow, SplashWindow};
...
pub struct Controller<Hardware> {
    splash_window: Option<SplashWindow>,
    launcher_window: Option<LauncherWindow>,
    hardware: Hardware,
}
